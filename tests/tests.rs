...
use spar_backend::model::{set_responsible, ApplicationCreateModel, AssetCreateModel, BusinessProcessApplicationCreateModel, BusinessProcessCreateModel, BusinessProcessRoleCreateModel, Creatable, ITSystemCreateModel, RoleCreateModel};
...
async fn populate_db() {
    ...
    set_responsible(bp_production.clone(), role_production_leader.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_integration.clone(), role_integration_leader.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_sales.clone(), role_sales_manager.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_support.clone(), role_support_lead.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_qa.clone(), role_qa_manager.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_hr.clone(), role_office_manager.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_finances.clone(), role_cfo.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    set_responsible(bp_strategic_planning.clone(), role_ceo.clone(), &mut tx).await.unwrap();
    BusinessProcessRoleCreateModel{
