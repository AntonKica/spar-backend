use spar_backend::{create_connection, setResponsible, BusinessProcessCreateModel, BusinessProcessRoleCreateModel, BusinessProcessType, RoleCreateModel};
...
async fn populate_db() {
    ...
    setResponsible(bp_product_development.clone(), role_cto.clone(), &db).await.unwrap();
    ...
    setResponsible(bp_production.clone(), role_production_leader.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_integration.clone(), role_integration_leader.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_sales.clone(), role_sales_manager.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_support.clone(), role_support_lead.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_qa.clone(), role_qa_manager.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_hr.clone(), role_office_manager.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_finances.clone(), role_cfo.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
    ...
    setResponsible(bp_strategic_planning.clone(), role_ceo.clone(), &db).await.unwrap();
    BusinessProcessRoleCreateModel{
